    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 order-2 lg:order-1">
                <div id="cart-items" class="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden">
                    <!-- Cart Header -->
                    <div class="bg-orange-50 px-4 sm:px-6 py-4 border-b border-orange-100">
                        <h2 class="text-base sm:text-lg font-bold text-gray-800">Your Items</h2>
                    </div>
        ...
        <div id="customer-details-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
            <div class="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
                <div class="flex items-center justify-between mb-4 sm:mb-6">
                    <h3 class="text-xl sm:text-2xl font-bold text-gray-800">Customer Details</h3>
                ...
                <form id="customer-details-form" class="space-y-6">
                    <div>
                        ...
                        <input type="text" id="customer-name" required
                               class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 text-base"
                    ...
                    <div class="flex gap-4">
                        ...
                        <button type="submit" class="flex-1 bg-green-500 hover:bg-green-600 text-white py-3 rounded-lg font-semibold transition-colors text-sm sm:text-base">
