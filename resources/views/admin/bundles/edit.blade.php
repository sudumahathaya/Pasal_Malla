...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600">Update bundle information</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form method="POST" action="{{ route('admin.bundles.update', $bundle) }}" enctype="multipart/form-data" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $bundle->name) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="name_sinhala" id="name_sinhala" value="{{ old('name_sinhala', $bundle->name_sinhala) }}"
                    ...
                    <div>
                        ...
                        <input type="number" name="original_price" id="original_price" value="{{ old('original_price', $bundle->original_price) }}" step="0.01" min="0" required
                    ...
                    <div>
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price', $bundle->price) }}" step="0.01" min="0" required
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <img src="{{ asset('storage/' . $bundle->image) }}" alt="{{ $bundle->name }}" class="h-32 w-32 object-cover rounded-lg">
                        </div>
                    </div>
                    @endif
                    ...
                    <div>
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                            {{ $bundle->image ? 'Update Image' : 'Bundle Image' }}
                        </label>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $bundle->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description_sinhala" id="description_sinhala" rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('description_sinhala') border-red-500 @enderror">{{ old('description_sinhala', $bundle->description_sinhala) }}</textarea>
