            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name_sinhala" id="name_sinhala" value="{{ old('name_sinhala', $product->name_sinhala) }}"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description_sinhala" id="description_sinhala" rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('description_sinhala') border-red-500 @enderror">{{ old('description_sinhala', $product->description_sinhala) }}</textarea>
