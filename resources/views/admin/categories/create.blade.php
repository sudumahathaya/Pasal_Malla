        ...
        <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name_sinhala" id="name_sinhala" value="{{ old('name_sinhala') }}" required
                ...
                <div>
                    ...
                    <input type="text" name="icon" id="icon" value="{{ old('icon') }}" placeholder="e.g., fas fa-book"
