...
@section('content')
    <!-- Hero Section -->
    <section class="hero-gradient text-white py-6 sm:py-8 md:py-12 lg:py-16 relative overflow-hidden min-h-[40vh] sm:min-h-[45vh] md:min-h-[50vh] lg:min-h-[55vh]">
        <!-- Background Image -->
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-10 items-center w-full">
                <div class="text-center lg:text-left">
                    <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 md:mb-6 leading-tight">
                        ...
                        <span class="block text-sm sm:text-base md:text-lg lg:text-2xl text-blue-100 font-normal mt-1 sm:mt-2">ලමයෙක් පාසලට ගන්න ඕන හම
                            දේකම!</span>
                    </h1>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 px-2 sm:px-0">
                        <a href="{{ route('products.index') }}"
                            class="btn-secondary text-white px-6 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-4 lg:py-5 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base md:text-lg inline-flex items-center justify-center pulse-glow">
                            <i class="fas fa-shopping-bag mr-2 sm:mr-3"></i>
                            Shop Now
                        </a>
                        <a href="{{ route('bundles.index') }}" class="btn-glass px-6 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-4 lg:py-5 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base md:text-lg">
