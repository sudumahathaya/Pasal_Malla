...
@section('content')
<!-- Hero Section -->
<section class="hero-gradient text-white py-24 lg:py-32 relative overflow-hidden min-h-[50vh] lg:min-h-[60vh]">
    <!-- Banner image covering full hero area -->
    <img src="{{ asset('image/banner.png') }}" alt="" aria-hidden="true"
         class="absolute inset-0 h-20% w-10%& object-cover pointer-events-none select-none">
    <div class="container mx-auto px-4 relative z-10 min-h-[60vh] lg:min-h-[70vh] flex items-center">
