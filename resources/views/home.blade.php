...
@section('content')
    <!-- Hero Section -->
    <section class="hero-gradient text-white py-8 sm:py-12 md:py-16 lg:py-32 relative overflow-hidden min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] lg:min-h-[90vh]">
        <!-- Background Image -->
        ...
        <div class="container mx-auto px-3 sm:px-4 relative z-10 min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] lg:min-h-[90vh] flex items-center">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-10 items-center w-full">
                <div class="text-center lg:text-left">
                    <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-7xl font-bold mb-3 sm:mb-4 md:mb-6 leading-tight">
                        <span class="block">PasalMalla</span>
                        <span class="block text-sm sm:text-base md:text-lg lg:text-4xl text-blue-100 font-normal mt-1 sm:mt-2">ලමයෙක් පාසලට ගන්න ඕන හම
                            දේකම!</span>
                    </h1>
                    <p class="text-sm sm:text-base md:text-lg lg:text-2xl mb-4 sm:mb-6 md:mb-8 text-blue-100 leading-relaxed px-2 sm:px-0">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 px-2 sm:px-0">
                        <a href="{{ route('products.index') }}"
                            class="btn-secondary text-white px-6 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-4 lg:py-5 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base md:text-lg lg:text-xl inline-flex items-center justify-center pulse-glow">
                            <i class="fas fa-shopping-bag mr-2 sm:mr-3"></i>
                            Shop Now
                        </a>
                        <a href="{{ route('bundles.index') }}" class="btn-glass px-6 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-4 lg:py-5 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base md:text-lg lg:text-xl">
    ...
    <!-- Categories Section -->
    <section class="py-8 sm:py-12 md:py-16 lg:py-24 bg-gradient-to-br from-white to-gray-50 ">
        <div class="container mx-auto px-3 sm:px-4">
            <div class="text-center mb-6 sm:mb-8 md:mb-12">
                ...
                <div class="w-12 sm:w-16 md:w-20 lg:w-24 h-1 bg-gradient-to-r from-orange-500 to-red-500 mx-auto mt-2 sm:mt-3 md:mt-4 rounded-full"></div>
            </div>

            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4 md:gap-6 lg:gap-8 max-w-7xl mx-auto">
                @foreach ($categories as $category)
                    <a href="{{ route('products.index', ['category' => $category->slug]) }}"
                        ...
                        <div class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-2 sm:mb-3 md:mb-4 lg:mb-6 group-hover:scale-110 transition-transform duration-300">
                            {{ $category->icon ?? '📚' }}</div>
                        <h3 class="font-bold text-gray-800 mb-1 sm:mb-2 md:mb-3 text-xs sm:text-sm md:text-base lg:text-lg leading-tight">{{ $category->name }}</h3>
                        <p class="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3 md:mb-4 leading-tight">{{ $category->name_sinhala }}</p>
                        <div
    ...
    <section class="py-8 sm:py-12 md:py-16 lg:py-20 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100">
        <div class="container mx-auto px-3 sm:px-4">
            <div class="text-center mb-6 sm:mb-8 md:mb-12">
                ...
                <p class="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 font-medium px-2 sm:px-0">Save money with our carefully curated school supply bundles
                </p>
                <div class="w-12 sm:w-16 md:w-20 lg:w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mt-2 sm:mt-3 md:mt-4 rounded-full"></div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 lg:gap-10">
                @foreach ($featuredBundles as $bundle)
                    <div class="card-hover bg-white rounded-xl sm:rounded-2xl md:rounded-3xl overflow-hidden shadow-xl border border-gray-100">
                        <div class="relative">
                        ...
                        <div class="p-3 sm:p-4 md:p-6 lg:p-8">
                            <h3 class="text-base sm:text-lg md:text-xl font-bold text-gray-800 mb-1 sm:mb-2 md:mb-3 group-hover:text-orange-600 transition-colors leading-tight">
                                {{ $bundle->name }}</h3>
                            <p class="text-xs sm:text-sm md:text-base text-gray-600 mb-1 sm:mb-2 md:mb-3 leading-tight">{{ $bundle->name_sinhala }}</p>
                            <p class="text-xs sm:text-sm text-gray-500 mb-3 sm:mb-4 md:mb-6 leading-tight">{{ Str::limit($bundle->description, 50) }}</p>
    ...
    <section class="py-8 sm:py-12 md:py-16 lg:py-20 bg-gradient-to-br from-white to-orange-50">
        <div class="container mx-auto px-3 sm:px-4">
            <div class="text-center mb-6 sm:mb-8 md:mb-12">
                ...
                <p class="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 font-medium px-2 sm:px-0">Popular items loved by students and parents</p>
                <div class="w-12 sm:w-16 md:w-20 lg:w-24 h-1 bg-gradient-to-r from-orange-500 to-red-500 mx-auto mt-2 sm:mt-3 md:mt-4 rounded-full"></div>
            </div>
                    ...
                    <div
                        ...
                        <div class="p-3 sm:p-4 md:p-6 lg:p-8">
                            ...
                            @if ($product->name_sinhala)
                                <p class="text-xs sm:text-sm md:text-base text-gray-600 mb-2 sm:mb-3 md:mb-4 leading-tight">{{ $product->name_sinhala }}</p>
                            @endif
    ...
    <section class="py-8 sm:py-12 md:py-16 lg:py-20 bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100">
        <div class="container mx-auto px-3 sm:px-4">
            <div class="text-center mb-6 sm:mb-8 md:mb-12">
                ...
                <p class="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 font-medium px-2 sm:px-0">අම්මලා හදුවේ අම්මලා සමරන්න ❤️</p>
                <div class="w-12 sm:w-16 md:w-20 lg:w-24 h-1 bg-gradient-to-r from-orange-500 to-red-500 mx-auto mt-2 sm:mt-3 md:mt-4 rounded-full"></div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 lg:gap-10">
                <div class="text-center group">
                    ...
                    <h3 class="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 mb-2 sm:mb-3 md:mb-4">Free Island-wide Delivery</h3>
                ...
                <div class="text-center group">
                    ...
                    <h3 class="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 mb-2 sm:mb-3 md:mb-4">Cash on Delivery</h3>
                    <p class="text-gray-600 text-sm sm:text-base md:text-lg leading-relaxed px-2 sm:px-0">
                ...
                <div class="text-center group">
                    ...
                    <h3 class="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 mb-2 sm:mb-3 md:mb-4">Quality Guaranteed</h3>
                    <p class="text-gray-600 text-sm sm:text-base md:text-lg leading-relaxed px-2 sm:px-0">
    ...
    <section class="py-8 sm:py-12 md:py-16 lg:py-20 hero-gradient text-white relative overflow-hidden">
        ...
        <div class="absolute bottom-2 sm:bottom-4 md:bottom-10 left-2 sm:left-4 md:left-10 float-animation opacity-10" style="animation-delay: 1s;">
            <i class="fas fa-heart text-xl sm:text-3xl md:text-4xl lg:text-6xl"></i>
        </div>
        <div class="container mx-auto px-3 sm:px-4 text-center">
            <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 sm:mb-6 md:mb-8">Ready to Get Started?</h2>
            <p class="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 md:mb-12 text-blue-100 font-medium px-2 sm:px-0">
                Join thousands of happy parents who trust PasalMalla for their children's school needs
            </p>
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <a href="{{ route('products.index') }}" class="btn-white px-6 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-4 lg:py-5 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base md:text-lg lg:text-xl">
                    <i class="fas fa-shopping-bag mr-2 sm:mr-3"></i>
                    Start Shopping
                </a>
                <a href="{{ route('contact') }}" class="btn-glass px-6 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-4 lg:py-5 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base md:text-lg lg:text-xl border-white">
