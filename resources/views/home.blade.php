            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center w-full">
                <div class="text-center lg:text-left">
                    <h1 class="text-5xl lg:text-7xl font-bold mb-6 leading-tight">
                        ...
                        <span class="block text-3xl lg:text-4xl text-blue-100 font-normal">ලමයෙක් පාසලට ගන්න ඕන හම
                            දේකම!</span>
                    </h1>
                    ...
                    <div class="flex flex-col sm:flex-row gap-6">
                        <a href="{{ route('products.index') }}"
                            class="btn-secondary text-white px-12 py-5 rounded-2xl font-bold text-xl inline-flex items-center justify-center pulse-glow">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 max-w-7xl mx-auto">
                @foreach ($categories as $category)
                    <a href="{{ route('products.index', ['category' => $category->slug]) }}"
                        ...
                        <div
                            class="mt-4 text-orange-600 group-hover:text-orange-700 transition-colors group-hover:scale-110 transform duration-300">
    ...
    <section class="py-20 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="text-2xl text-gray-600 font-medium">Save money with our carefully curated school supply bundles
                </p>
                ...
                @foreach ($featuredBundles as $bundle)
                    <div class="card-hover bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100">
                        <div class="relative">
                            ...
                            <div
                                class="absolute top-4 right-4 bg-gradient-to-r from-red-500 to-red-600 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg animate-pulse">
                                Save {{ $bundle->getSavingsPercentage() }}%
                            </div>
                            <div
                                class="absolute bottom-4 left-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg">
                        ...
                        <div class="p-8">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <div>
                                    <span class="text-3xl font-bold text-orange-600">Rs.
                                        {{ number_format($bundle->price, 2) }}</span>
                                    <div class="text-sm text-gray-500 line-through">Rs.
            ...
            <div class="text-center mt-12">
                <a href="{{ route('bundles.index') }}"
                    class="btn-secondary text-white px-12 py-5 rounded-2xl font-bold text-xl">
                    <i class="fas fa-gift mr-3"></i>
                    View All Bundles
                </a>
            </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                @foreach ($featuredProducts as $product)
                    <div
                        class="card-hover bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100 group relative">
                        <div class="relative">
                            ...
                            @if ($product->stock_quantity <= 5)
                                <div
                                    class="absolute top-4 left-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg">
                                    Low Stock
                                </div>
                            @endif
                            <div
                                class="absolute bottom-4 left-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-2 rounded-full text-xs font-bold shadow-lg">
                                <i class="fas fa-star mr-1"></i>Featured
                            </div>
                        </div>
                        <div class="p-8">
                            <div
                                class="text-sm text-orange-600 font-bold bg-orange-50 px-4 py-2 rounded-full mb-4 inline-block">
                            ...
                            <div class="flex items-center justify-between mb-6">
                                <div>
                                    <span class="text-2xl font-bold text-orange-600">Rs.
                                        {{ number_format($product->getCurrentPrice(), 2) }}</span>
                                    @if ($product->hasDiscount())
                                        <div class="text-sm text-gray-500 line-through mt-1">Rs.
                            ...
                            <div class="flex gap-3">
                                <a href="{{ route('products.show', $product) }}"
                                    class="flex-1 btn-primary text-white py-4 rounded-2xl font-bold text-center hover:shadow-lg transition-all">
                                    <i class="fas fa-eye mr-2"></i>
                                    View Details
                                </a>
                                <button
                                    class="add-to-cart bg-gradient-to-r from-orange-100 to-orange-200 hover:from-orange-200 hover:to-orange-300 text-orange-700 px-5 py-4 rounded-2xl transition-all hover:scale-110 hover:shadow-lg"
            ...
            <div class="text-center mt-12">
                <a href="{{ route('products.index') }}"
                    class="btn-primary text-white px-12 py-5 rounded-2xl font-bold text-xl">
                    <i class="fas fa-shopping-bag mr-3"></i>
                    Shop All Products
                </a>
            </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div class="text-center group">
                    <div
                        class="w-24 h-24 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                ...
                <div class="text-center group">
                    <div
                        class="w-24 h-24 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                ...
                <div class="text-center group">
                    <div
                        class="w-24 h-24 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
